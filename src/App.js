    ...
    <LeftSection className="LeftSection">
      ...
      <Section2>
        ...
        <p className="custom-font">
          ...
          will automatically reinvest your rewards back into farmers
        </p>
        <p className="custom-font">
          <u>
            <strong>#3 - CLAIM REWARDS:</strong>
          </u>{" "}
          This will transfer your accumulated $BRETT rewards directly into your
          wallet
        </p>
      </Section2>
      ...
      <Section2>
        ...
        <p className="custom-font">
          The key to maximizing your rewards lies in the quantity of brett you
      ...
      <Section>
        ...
        >
          ...
          >
            {userReward} BRETT (${claimableValue})
          </p>
        </div>
